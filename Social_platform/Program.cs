...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        var Bayaa= platform.Signup("Bayaa", "bayaa@gmail.com", "pwd", 18) ?? throw new Exception("signup failed");
        ...
        // Feed-г хэвлэ
        platform.PrintFeed();
        // Консол цонх програм дууссаны дараа шууд хаагдахаас сэргийлнэ (IDE-д ажиллуулахад харагдахад тусална)
        Console.WriteLine("\nPress Enter to exit...");
        Console.ReadLine();
